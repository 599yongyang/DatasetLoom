...
export function DatasetCards() {
    ...
    return (
        <div className="grid grid-cols-1 gap-4 px-4 lg:px-4 @xl/main:grid-cols-2 @5xl/main:grid-cols-4">
            <Card className="@container/card relative overflow-hidden">
                ...
                <CardHeader className="pb-3">
                    <div className="flex items-center justify-between">
                        ...
                        <div
                            className="flex items-center justify-center w-8 h-8 rounded-lg bg-blue-50 dark:bg-blue-950">
                        ...
                        <div className={'text-sm font-medium pt-4'}>
                            <span>
                                {kanbanData?.confirmedCount > 0 && (
                                    <span>
                                    {t('dataset_cards.confirmed', {count: parseFloat(((kanbanData?.confirmedCount / kanbanData?.allCount) * 100).toFixed(2))})}
                                    </span>
                                )}
                            </span>
                        </div>
            ...
            <Card className="@container/card relative overflow-hidden">
                <div
                    className="absolute top-0 right-0 w-20 h-20 bg-green-500/10 rounded-full -translate-y-10 translate-x-10"/>
                <CardHeader className="pb-3">
                    <div className="flex items-center justify-between">
                        <CardDescription className="text-sm font-medium">{t('dataset_cards.sft')}</CardDescription>
                        <div
                            className="flex items-center justify-center w-8 h-8 rounded-lg bg-green-50 dark:bg-green-950">
            ...
            <Card className="@container/card relative overflow-hidden">
                ...
                <CardHeader className="pb-3">
                    <div className="flex items-center justify-between">
                        ...
                        <div
                            className="flex items-center justify-center w-8 h-8 rounded-lg bg-purple-50 dark:bg-purple-950">
            ...
            <Card className="@container/card relative overflow-hidden">
                <div
                    className="absolute top-0 right-0 w-20 h-20 bg-amber-500/10 rounded-full -translate-y-10 translate-x-10"/>
                <CardHeader className="pb-3">
                    <div className="flex items-center justify-between">
                        <CardDescription className="text-sm font-medium">{t('dataset_cards.cot')}</CardDescription>
                        <div
                            className="flex items-center justify-center w-8 h-8 rounded-lg bg-amber-50 dark:bg-amber-950">
