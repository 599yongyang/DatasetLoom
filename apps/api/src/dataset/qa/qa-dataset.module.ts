...
@Module({
    ...
    providers: [QaDatasetService, QuestionService, ProjectService, ImagesService, ModelConfigService, ExportDatasetService, TextDatasetGenerator, ImageDatasetGenerator, EvaluationGenerator],
})
