...
export function SidebarHistory() {
    ...
    const { data: paginatedChatHistories, setSize, isValidating, isLoading, mutate } = useGetChatHistory(projectId);
    ...
    const handleDelete = async () => {
        const deletePromise = fetch(`/api/project/${projectId}/chat?id=${deleteId}`, {
            method: 'DELETE'
        });
