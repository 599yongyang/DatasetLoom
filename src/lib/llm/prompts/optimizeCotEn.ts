import type { OptimizeCotPromptOptions } from '@/lib/llm/prompts/type';

export default function getOptimizeCotEnPrompt(options: OptimizeCotPromptOptions) {
    const { originalQuestion, answer, originalCot } = options;
